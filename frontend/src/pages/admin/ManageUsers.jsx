...
export default function ManageUsers() {
  ...
  // REPLACE ONLY THIS STATS BLOCK
// inside ManageUsers.jsx
                  ...
                  <div>
                    {editingUser === user._id ? (
                      <input
                        ...
                        className="px-3 py-1 rounded-lg border dark:bg-slate-800 dark:text-white"
                      />
                    ) : (
                      <p className="font-semibold text-gray-900 dark:text-white">
                        {user.name}
                    ...
                    <>
                      ...
                      user._id ? (
                        <button
                          ...
                          className="px-4 py-2 rounded-xl bg-green-500 text-white hover:bg-green-600 transition-all"
                        >
                          Save
                        </button>
                      ) : (
                        <button
                          ...
                          className="flex items-center gap-2 px-4 py-2 rounded-xl bg-indigo-500 text-white hover:bg-indigo-600 transition-all"
                        >
                          <Pencil size={16} />
                          Edit
                        </button>
